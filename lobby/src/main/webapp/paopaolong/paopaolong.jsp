...
<body>
	<div style="position: absolute; top: 0px; left: 0px;">
		<img alt="" src="/resources/images/loading.gif" style="width:640;height:530;">
	</div>
	<div style="z-index: 99">
		<object id="j2me-object" classid="ipanel:j2me-midp2" width="644" height="534">
			...
			<param name="jad" value="${pageContext.request.contextPath}/resources/games/paopaolong/paopaolong.jad">
			<param name="jar" value="${pageContext.request.contextPath}/resources/games/paopaolong/paopaolong.jar">
