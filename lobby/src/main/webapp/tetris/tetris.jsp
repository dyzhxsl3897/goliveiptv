...
<body>
	...
	<div style="z-index: 99">
		<object id="j2me-object" classid="ipanel:j2me-midp2" width="644" height="534">
			...
			<param name="jad" value="${pageContext.request.contextPath}/resources/games/tetris/tetris.jad">
			<param name="jar" value="${pageContext.request.contextPath}/resources/games/tetris/tetris.jar">
