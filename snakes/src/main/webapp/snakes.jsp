...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/snakes.css">

<title>Snakes Game Pad</title>
</head>
<body background="${pageContext.request.contextPath}/resources/images/snakes/background.png">
	<div id="main">
		<!-- Play Board: Height: 400px, Width: 550px -->
		<div id="playboard"></div>
	</div>
	<img id="titleImg" src="${pageContext.request.contextPath}/resources/images/snakes/title.png">
