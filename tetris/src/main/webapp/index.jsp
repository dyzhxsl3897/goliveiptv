...
<body background="/resources/images/Background.png">
	<div id="playboard" style="position: absolute; top: 14px; left: 156px; width: 300px; height: 510px;"></div>
	...
	<div id="score" style="position: absolute; top: 225px; left: 40px; width: 70px; height: 20px;">0</div>
